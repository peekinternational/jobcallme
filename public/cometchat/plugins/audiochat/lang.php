...
${$addonname.'_language'}['popup_already_open'] = setLanguageValue('popup_already_open','Multimedia session is already open. Please close the existing popup and try again.',$lang,$addontype,$addonname);${$addonname.'_language'}['video_call'] = setLanguageValue('video_call','Video call',$lang,$addontype,$addonname);
