...
$sql_queries['getChatroomData'] = "select {limitClause} cometchat_chatroommessages.id id, cometchat_chatroommessages.message, cometchat_chatroommessages.sent, m.{usertable_username} [from],
