...
<td class="m_1888394735623576276content-cell" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px">
                                        <h1 style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#2f3133;font-size:19px;font-weight:bold;margin-top:0;text-align:left">@lang('home.Hello!')  {{$Name}}{{$lastName}} @lang('home.welcomeend')</h1>
<p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">@lang('home.You are receiving this email because we received a verify email request for your account.')</p>
...
<td style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box">
                                    <a href="{{ url('verifyUser/'.$id)}}" class="m_1888394735623576276button m_1888394735623576276button-blue" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;border-radius:3px;color:#fff;display:inline-block;text-decoration:none;background-color:#3097d1;border-top:10px solid #3097d1;border-right:18px solid #3097d1;border-bottom:10px solid #3097d1;border-left:18px solid #3097d1" target="_blank">@lang('home.Click To Verify')</a>
                                </td>
                            </tr></tbody></table>
</td>
                </tr></tbody></table>
