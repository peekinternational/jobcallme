...
<section id="jobs" style="margin-bottom:70px">
    <div class="container">
        ...
        <div class="col-md-2 jobApp-tabs2 jobMblTabs hidden-sm hidden-md hidden-lg">
            <h5 class="mtab-heading"><img src="/frontend-assets/images/manage_icon1-1.png" style="padding-top:0px"> @lang('home.account')</h5>
            <ul class="jobMblTabs">
                <ul class="nav nav-tabs jobMblTabs">
                    <li>
                        <a id="password" class="mblTabBtn nav-tab-active" data-toggle="tab" href="#password" role="tab" aria-controls="password"><img src="/frontend-assets/images/manage_icon2-1.png" style="padding-top:0px"> @lang('home.changepassword')</a>
                    </li>
                    <li>
                        <a id="profile" class=" mblTabBtn" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"><img src="/frontend-assets/images/manage_icon3-1.png" style="padding-top:0px"> @lang('home.editprofile')</a>
                    </li>
                    <li>
                        <a id="notification" class="mblTabBtn" data-toggle="tab" href="#notification" role="tab" aria-controls="notification"><img src="/frontend-assets/images/manage_icon4-1.png" style="padding-top:0px"> @lang('home.notification')</a>
                    </li>
                    <li>
                        <a id="privacy" class="mblTabBtn" data-toggle="tab" href="#privacy" role="tab" aria-controls="privacy"><img src="/frontend-assets/images/manage_icon5-1.png" style="padding-top:0px"> @lang('home.p_privacy')</a>
                    </li>
                </ul>
                <h5 class="mtab-heading"><img src="/frontend-assets/images/manage_icon6-1.png" style="padding-top:0px"> @lang('home.organization')</h5>
                <ul class="nav nav-tabs jobMblTabs">
                    <li>
                        <a href="{{ url('account/employer/departments') }}" class=""><img src="/frontend-assets/images/manage_icon7-1.png" style="padding-top:0px"> @lang('home.departments')</a>
                    </li>
                    <li>
                        <a href="{{ url('account/employer/organization') }}" class=" ext-link"><img src="/frontend-assets/images/manage_icon8-1.png" style="padding-top:0px"> @lang('home.editorganization')</a>
                    </li>
                    <li>
                        <a href="{{ url('account/employer/interview-venues/') }}" class="  ext-link"><img src="/frontend-assets/images/manage_icon9-1.png" style="padding-top:0px"> @lang('home.interviewvenues')</a>
                    </li>
                    <li>
                        <a href="{{ url('account/employer/users/') }}" class=" ext-link"><img src="/frontend-assets/images/manage_icon10-1.png" style="padding-top:0px"> @lang('home.users')</a>
                    </li>
                    <li>
                        <a href="{{ url('account/employer/addevaluation/') }}" class="  ext-link"><img src="/frontend-assets/images/manage_icon11-1.png" style="padding-top:0px"> @lang('home.evaluationforms')</a>
                    </li>
                    <li>
                        <a href="{{ url('account/employer/questionnaires') }}" class=" ext-link"><img src="/frontend-assets/images/manage_icon12-1.png" style="padding-top:0px"> @lang('home.setquestionnaires')</a>
                    </li>
                </ul>
                ...
                <h5 class="mtab-heading" id="credit_plan"><img src="/frontend-assets/images/manage_icon13-1.png" style="padding-top:0px"> @lang('home.subscription')</h5>
                <ul class="nav nav-tabs jobMblTabs">
                    <li>
                        <a id="credit" class=" mblTabBtn"><img src="/frontend-assets/images/manage_icon14-1.png" style="padding-top:0px"> @lang('home.credits')</a>
                    </li>
                    <li>
                        <a href="{{ url('account/employer/orders') }}" class="  ext-link"><img src="/frontend-assets/images/manage_icon15-1.png" style="padding-top:0px"> @lang('home.orders')</a>
                    </li>
                </ul>
                
                <h5 class="mtab-heading"><img src="/frontend-assets/images/manage_icon16-1.png" style="padding-top:0px"> @lang('home.deactivation')</h5>
                <ul class="nav nav-tabs jobMblTabs">
                    <li>
                        <a class="btn btn-block" data-popup-open="popup-1" style="margin-bottom:10px"><img src="/frontend-assets/images/manage_icon17-1.png" style="padding-top:0px"> @lang('home.deactivateaccount')</a>
                    </li>
                </ul>
            </ul>
        </div>
        ...
        <div class="col-md-2 jobApp-tabs hidden-xs">
			...
			<a href="{{ url('account/employer/questionnaires') }}" class="btn btn-block jaTabBtn ext-link"><img src="/frontend-assets/images/manage_icon12.png" style="padding-top:0px">@lang('home.setquestionnaires')</a>
            <!-- <a class="btn btn-block jaTabBtn">Users</a>
            <a class="btn btn-block jaTabBtn">Evaluation Form</a>
            <a class="btn btn-block jaTabBtn">Questionnaires</a> -->
