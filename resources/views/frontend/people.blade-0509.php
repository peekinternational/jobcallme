              ...
              <div class="col-md-2 col-sm-4 col-xs-6">
                <div class="fp-item" style="height: 256px;">
                  <a href="{{ url('account/employer/application/applicant/'.$people->userId) }}">
                    <div class="fp-img">
                      <img src="@if($people->pImage == 'Yes') {{ $pImage }} @else @if($people->genderpeople == 'Male' or $people->genderpeople == 'Man') {{ url('profile-photos/profile-logo.jpg ')}} @else {{ url('profile-photos/profile-logo2.jpg ')}} @endif @endif">
