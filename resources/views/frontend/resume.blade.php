...
<section id="myResume" style="margin-bottom:70px">
	...
	<div class="follow-companies5" style="background:#57768a;color:#fff;margin-top:50px;margin-bottom:20px;">
					<h3 style="margin-left: 15px">@lang('home.resume')</h3><span><i class="fa fa-info-circle" aria-hidden="true"></i> 이력서 작성시 개인 이력서 정보 및 최종학력 정보가 없을 경우 자료등록을 할 수 없으며, 인재정보에 노출이 안됩니다.</span>
				</div>
