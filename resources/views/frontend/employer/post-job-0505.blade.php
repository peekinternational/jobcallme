...
<div class="container">
	  ...
	  <div class="row">
                ...
                <div fxflex="100" style="flex: 1 1 100%; box-sizing: border-box; max-width: 100%;background:#efefef;" class="ng-untouched ng-pristine ng-invalid hidden-xs">
                        <ul id="post-job-ad-types" class="text-center">
						 ...
						 @foreach($plan as $key=>$pay)
								...
								@if($pay->type == "Basic")
                            <!----><li style="position:relative;background-image:url('/frontend-assets/images/pay-job1.png');color:#fff;">
									<?php
                            ...
                            <!----><li style="position:relative;background-image:url('/frontend-assets/images/pay-job2.png');color:#fff;">
								...
								@endif
								@if($pay->type == "Special")
                            <!----><li style="position:relative;background-image:url('/frontend-assets/images/pay-job3.png');color:#fff;">
									<?php
								...
								@endif
								@if($pay->type == "Latest")
                            <!----><li style="position:relative;background-image:url('/frontend-assets/images/pay-job4.png');color:#fff;">
									<?php
								...
								@endif
								@if($pay->type == "Hot")
                            <!----><li style="position:relative;background-image:url('/frontend-assets/images/pay-job5.png');color:#fff;">
									<?php
										$payad_text = "hot_text";
								...
								@endif
								@if($pay->type == "Top Job")
                            <!----><li style="position:relative;background-image:url('/frontend-assets/images/pay-job6.png');color:#fff;">
									<?php
										$payad_text = "top_text";
								...
								@endif
								@if($pay->type == "Premium")
                            <!----><li style="position:relative;background-image:url('/frontend-assets/images/pay-job7.png');color:#fff;">
									<?php
							   ...
							   <div class="mat-radio-label-content"><span style="display:none">&nbsp;</span>
                                ...
                                <div class="text-center">
									...
									@if($payment->title == "Basic")
										...
										@else
										<div style="font-size: 11px;padding:30px 0px 0 0px;" class="text-center">@lang('home.'.$payad_text)</div>
										<div style="font-size: 11px;padding:7px 0px 0 0px;" class="text-center">@lang('home.'.$payad_text2)</div>
										<div style="font-size: 11px;padding:7px 0px 0 0px;" class="text-center">@lang('home.'.$payad_text3)</div>
										<div style="font-size: 11px;padding:7px 0px 0 0px;" class="text-center">@lang('home.'.$payad_text4)</div>
										@if(app()->getLocale() == "kr")
			<div style="font-size: 11px;padding:7px 0px 0 0px;" id="tax_text5{{$key}}" class="text-center">@lang('home.'.$payad_text5)</div>
		@else
		...
		@endif
										...
										<div style="font-size: 12px;text-align: center;color:#ff3b3b;padding-top:7px;" ><span style="color:#fff;">@lang('home.'.$payad_text7)</span> @lang('home.'.$payad_text6)</span>
										</div>
										<div style="font-size: 10px;text-align: center;color:#f0ad4e;padding-top:5px;" >@lang('home.'.$payad_text8)</span>
										</div>
										<div class="credits b" style="font-size: 13px;text-align: center;padding-top:10px;" >
							   ...
							   <div class="mat-radio-label-content"><span style="display:none">&nbsp;</span>
                                ...
                                <div class="text-center">
                                    <!----><label for="{!! $payment->id!!}">
										...
										<div style="font-size: 11px;padding:7px 0px 0 0px;" class="text-center">@lang('home.'.$payad_text4)</div>
										@if(app()->getLocale() == "kr")
			<div style="font-size: 11px;padding:7px 0px 0 0px;" id="tax_text5{{$k}}" class="text-center">@lang('home.'.$payad_text5)</div>
		@else
			<div style="font-size: 11px;padding:7px 0px 0 0px;" class="text-center">@lang('home.'.$payad_text5)</div>
		@endif
										@endif
		...
		@endif</b></span>
							   ...
							   <div class="mat-radio-label-content"><span style="display:none">&nbsp;</span>
                                ...
                                <div class="text-center">
                                    <!----><label for="{!! $payment->id!!}">
                                        @if($payment->title == "Basic")
										<div style="font-size: 11px;padding:30px 0px 0px 0px;" class="text-center">@lang('home.'.$payad_text)</div>
										<div style="font-size: 11px;padding:20px 0px 0px 0px;" class="text-center">@lang('home.'.$payad_text2)</div>
										<div style="font-size: 11px;padding:20px 0px 0px 0px;" class="text-center">@lang('home.'.$payad_text3)</div>
										@else
										<div style="font-size: 11px;padding:30px 0px 0 0px;" class="text-center">@lang('home.'.$payad_text)</div>
										<div style="font-size: 11px;padding:7px 0px 0 0px;" class="text-center">@lang('home.'.$payad_text2)</div>
										<div style="font-size: 11px;padding:7px 0px 0 0px;" class="text-center">@lang('home.'.$payad_text3)</div>
										<div style="font-size: 11px;padding:7px 0px 0 0px;" class="text-center">@lang('home.'.$payad_text4)</div>
										@if(app()->getLocale() == "kr")
			<div style="font-size: 11px;padding:7px 0px 0 0px;" id="tax_text5{{$keys}}" class="text-center">@lang('home.'.$payad_text5)</div>
		@else
			<div style="font-size: 11px;padding:7px 0px 0 0px;" class="text-center">@lang('home.'.$payad_text5)</div>
		@endif
