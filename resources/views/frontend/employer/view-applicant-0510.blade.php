                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="profile-img">
                                    <img src="@if($privacy->profileImage == 'Yes') {{ $pImage}} @else @if($applicant->gender == 'Male' or $applicant->gender == 'Man') {{url('profile-photos/profile-logo.jpg')}} @else {{url('profile-photos/profile-logo2.jpg')}} @endif @endif" style="width: 100%">
                                </div>
                            ...
                            <div class="col-md-9 personal-info-right">
                                <h3 class="hidden-sm">{{$applicant->firstName}} {{$applicant->lastName}}<span class="pull-right"><button class="btn btn-primary" onclick="$('#offerdModel').modal('show')"><i class="fa fa-bullhorn"></i> @lang('home.Offerd Interview')</button></span></h3>
