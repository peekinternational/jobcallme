                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="profile-img">
                                    @if($resumedown > 0) <img src="{{ $pImage}}" style="width: 100%"> @else <img src="@if($privacy->profileImage == 'Yes') {{ $pImage}} @else @if($applicant->gender == 'Male' or $applicant->gender == 'Man') {{url('profile-photos/profile-logo.jpg')}} @else {{url('profile-photos/profile-logo2.jpg')}} @endif @endif" style="width: 100%"> @endif
                            ...
                            <div class="col-md-9 personal-info-right">
                                ...
                                <div class="professional-summary">
									...
									<p>{!! $applicant->about !!}</p>
									@else
									<p style="color:#337ab7"><b><i class="fa fa-download"></i> @lang('home.View resume download')</b></p>
									@endif
                                </div>
                            </div>
                        </div>
                            ...
                            $pos = strpos($appl->profilePhoto,"ttp");
                             ...
                             <div class="col-md-12 sr-item">
                              <div class="col-md-4 applicant-SimilarImg">
                                <img src="@if($appl->privacyImage == 'Yes') {{ $pImage }} @else @if($appl->genderpeople == 'Male' or $appl->genderpeople == 'Man') {{ url('profile-photos/profile-logo.jpg') }} @else {{ url('profile-photos/profile-logo2.jpg') }} @endif @endif" style="width: 70px;height:75px;">
                                </div>
                                <div class="col-md-8 sp-item">
                                <p><a href="{{ url('account/employer/application/applicant/'.$appl->userId) }}">@if($resumedown > 0) {!! $appl->firstName.' '.$appl->lastName !!} @else {{$appl->firstName}} <i class="fa fa-circle-o" aria-hidden="true"></i> <i class="fa fa-circle-o" aria-hidden="true"></i> @endif</a></p>
