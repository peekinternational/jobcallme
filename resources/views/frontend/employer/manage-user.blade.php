        ...
        <div class="col-md-2 jobApp-tabs2 jobMblTabs hidden-sm hidden-md hidden-lg">
            ...
            <ul class="jobMblTabs">
                ...
                <ul class="nav nav-tabs jobMblTabs">
                    ...
                    <li>
                        <a href="{{ url('account/employer/questionnaires') }}" class=" ext-link">@lang('home.setquestionnaires')</a>
                    </li>
                </ul>
                ...
                <ul class="nav nav-tabs jobMblTabs">
                    <li>
                        <a id="credit" class=" mblTabBtn">@lang('home.credits')</a>
                    </li>
                    <li>
                        ...
                        <table class="table">
							<tr>
                             <form action="{{ action('frontend\Employer@package') }}" method="post">
                              {!! csrf_field() !!} 
                                <td height="150px" style="padding-top:20px;padding-bottom:20px"> <div class="text-center" style="background:#7ec6d9;height:130px;width:230px;border-radius: 10px;"><img src="/frontend-assets/images/manage_credit3.png" style="padding-top:15px;"><br><span style="color:#fff;font-size:15px;"><b>@lang('home.Resume Downloads')</b></span></div></td>
                                <input type="hidden" value="Resume Download" name="type">
                                <td><input type="submit" class="btn btn-info" style="margin-top:50px;" value="@lang('home.Buy Now')"></td>
                                </form>
                            </tr>
                            <tr>
                            <form action="{{ action('frontend\Employer@package') }}" method="post">
