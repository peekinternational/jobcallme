                                    ...
                                    <!----><label for="{!! $payment->id!!}">
                                        ...
                                        <div class="credits b" style="font-size: 13px;text-align: center;" >@lang('home.pay_cost') : 
											...
											@if($payment->type == "Golden")
												...
												@else
													@if($payment->amount == "135")
													<div id="usd_text{{$key}} style="font-size: 13px;text-align: center;padding:10px 10px 0 15px;color:#db132f;" ><strike>＄150</strike> [10%]</div>
													@elseif($payment->amount == "97")
													<div id="usd_text{{$key}} style="font-size: 13px;text-align: center;padding:10px 10px 0 15px;color:#db132f;" ><strike>＄105</strike> [7%]</div>
													@elseif($payment->amount == "71")
													<div id="usd_text{{$key}} style="font-size: 13px;text-align: center;padding:10px 10px 0 15px;color:#db132f;" ><strike>＄75</strike> [5%]</div>
													@endif
												@endif
