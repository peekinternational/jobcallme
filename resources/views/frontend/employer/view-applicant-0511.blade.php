                    ...
                    <section class="personal-info-section" id="personal-information">
                        <div class="row">
                            ...
                            <div class="col-md-9 personal-info-right">
                                <h3 class="hidden-sm">@if($resumedown > 0) {{$applicant->firstName}} {{$applicant->lastName}} @else {{$applicant->firstName}} <i class="fa fa-circle-o" aria-hidden="true" style="font-size:17px"></i> <i class="fa fa-circle-o" aria-hidden="true" style="font-size:17px"></i> @endif<span class="pull-right"><button class="btn btn-primary" onclick="$('#offerdModel').modal('show')"><i class="fa fa-bullhorn"></i> @lang('home.Offerd Interview')</button></span></h3>
