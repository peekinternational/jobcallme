            ...
            <div class="col-md-2 hidden-xs">
                <div class="row">
                    <div class="col-md-12 jobApp-tabs">
                        ...
                        <a id="review" href="{{url('employer/status/reviews/all')}}" class="btn btn-block {{ $review }}"><i class="fa fa-file-o"></i>  @lang('home.Reviews')</a>
                    </div>
                </div>
            </div>
            <div class="col-md-10">
    ...
    $.ajax({
        ...
        success: function(response){
            if($.trim(response) != '1'){
                ...
                toastr.success('@lang("Action perform successfully2")', '', {timeOut: 5000, positionClass: "toast-bottom-center"});
