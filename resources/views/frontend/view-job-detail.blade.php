        ...
        <div class="col-md-9">
			...
			@endif
                ...
                <div class="jd-share-btn">
                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode('jobs/'.$job->jobId) }}" target="_blank">
                    ...
                    <a href="https://plus.google.com/share?url={{ urlencode('jobs/'.$job->jobId) }}" target="_blank" >
