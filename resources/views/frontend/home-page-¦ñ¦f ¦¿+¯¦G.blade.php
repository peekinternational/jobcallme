...
<div class="row">
      <div class="col-md-10 col-md-offset-2" style="padding-left:10px;padding-bottom:20px;">
     <span style="padding-left:10px;"><button type="submit" class="btn btn-warning btn-sm" id="Quickbutton2" onclick="myFunction2()"> @lang('home.Open Job AD V')  </button></span>
</div>

<section id="QuickView2" style="display:none;">
...
function myFunction2() {
    var x = document.getElementById("Quickbutton2");
    if (x.innerHTML === "@lang('home.Close Job AD V')") {
        x.innerHTML = "@lang('home.Open Job AD V')";
    } else {
        x.innerHTML = "@lang('home.Close Job AD V')";
    }
}
</script>
@endsection
